...
class TgUser(models.Model):
    ...
    user = models.OneToOneField('core.User', on_delete=models.CASCADE, null=True, blank=True, verbose_name='Пользователь')
    verification_code = models.CharField(max_length=20, unique=True, null=True, blank=True, verbose_name='Код подтверждения')

    @property
    def is_verified(self):
        return bool(self.verification_code)
